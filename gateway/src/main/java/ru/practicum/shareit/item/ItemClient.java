...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItem(ItemCreateDto newElement, long userId) {
        return post("", userId, newElement);
    }

    public ResponseEntity<Object> createComment(long itemId, long userId, CommentDto newElement) {
        return post("/" + itemId + "/comment", userId, newElement);
    }
}
